...
public class ReportManagement {
    ...
    public static Map<String, String> downloadURL(InputStream inputStream, String folderOut, MongoClientURI mongoURI) throws IOException {
